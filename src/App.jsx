...
import { priorityColor, assignProjectColors, getProjectColor, pastelize } from './lib/colors.js';
import { fmtMD, fmtYMD, fmtYMDJP, dayName, isWeekend, addDays, startOfDay, isSameDay, timeToMin, minToTime, fmtHM, parseHM, dtLocalToDate, dateToDtLocal, parseYMD } from './lib/datetime.js';
import { syncHolidays, isWorkingSaturday, isNonWorkingDay, COMPANY_PRESETS, VN_LUNAR_HOLIDAYS, vietnamHolidayCandidates, expandHolidayDates, DEFAULT_SETTINGS, getDailySlots, getDaySlots, getDayWorkingHours, getHoursPerDay, deadlineKey, effectiveDeadlineKey, deadlineInsertPriority, companyRank, companyDisplayRank, compareCompanyDisplay, companySequence, computeProjectOrder, subtractBusy, dayAbsence, isOnLeaveAt, dayOvertimeIntervals, dayWorkSlots, dayFreeIntervals, scheduleTasks, computeLateRisks, computeFreeHours, latestActualEnd, buildDoneSlots, maxOvertimeEndMin, elapsedHoursForSlots, workingHoursBetweenTs, projectEndTs } from './lib/scheduler.js';
