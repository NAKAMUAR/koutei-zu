...
import { Plus, Trash2, X, Search, StickyNote, Bell, BellOff } from 'lucide-react';
          ...
          grouped.map(([date, items]) => (
            <div key={date} style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, padding: '0 0 8px 0', borderBottom: `1px solid ${colors.border}`, marginBottom: 10 }}>
                ...
                {date === today && <span style={{ fontSize: 11, color: colors.accent, fontWeight: 600, letterSpacing: '0.08em' }}>今日</span>}
              </div>
